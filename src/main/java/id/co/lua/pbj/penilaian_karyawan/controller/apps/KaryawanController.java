...
public class KaryawanController {
    ...
    public void cetakPdf(HttpServletResponse response) {
        try {
            ...
            // Generate PDF
            ByteArrayOutputStream pdfStream = PdfGenerator.generateKaryawanReport(
                karyawanList,
                logoPath,
                companyName,
                companyAddress,
            ...
            String fileName = "Laporan_Data_Karyawan_" + dateFormat.format(new Date()) + ".pdf";
